...
function ComboboxChips({
	...
	return (
		<ComboboxPrimitive.Chips
			...
			className={cn(
				"dark:bg-input/30 border-input focus-within:border-foreground border focus-within:border-2 has-aria-invalid:border-destructive dark:has-aria-invalid:border-destructive/50 flex min-h-9 flex-wrap items-center gap-1.5 rounded-md bg-transparent bg-clip-padding px-2.5 py-1.5 text-sm shadow-xs transition-[color,box-shadow] has-data-[slot=combobox-chip]:px-1.5",
				className,
			)}
			{...props}
		/>
